...
ada_boost_model = AdaBoostClassifier(n_estimators=300, learning_rate=0.2)
...
bagging_model.fit(X=training_data, y=y_train)

# Fit your RandomForestClassifier to the training data
random_forest_model.fit(X=training_data, y=y_train)

# Fit your AdaBoostClassifier to the training data
ada_boost_model.fit(X=training_data, y=y_train)
...
bagging_y_predict = bagging_model.predict(X=testing_data)

# Predict using RandomForestClassifier on the test data
random_forest_y_predict = random_forest_model.predict(X=testing_data)

# Predict using AdaBoostClassifier on the test data
ada_boost_y_predict = ada_boost_model.predict(X=testing_data)
...
print_metrics(y_true=y_test, preds=bagging_y_predict, model_name="Bagging")

# Print Random Forest scores
print_metrics(y_true=y_test, preds=random_forest_y_predict, model_name="Random Forest")

# Print AdaBoost scores
print_metrics(y_true=y_test, preds=ada_boost_y_predict, model_name="AdaBoost")
